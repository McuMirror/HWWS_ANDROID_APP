...
public class MessageNotification
{
     ...
     * @see #cancel(Context)
     */
    public static void notify(final Context context,final String exampleString, final int number, final String SummaryText)
    {
        ...
        final String title = "Hochwasser Warnsystem";
